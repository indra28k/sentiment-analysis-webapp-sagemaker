...
### About the Developer
Indra Kumar Siripurapu is a Senior Data Analyst with over 8 years of experience in healthcare and pharmaceutical environments. He specializes in data validation, reconciliation, compliance-focused reporting, and dashboard development. With a strong background in SQL, Power BI, and SSRS, Indra focuses on translating complex reporting requirements into accurate, audit-ready outputs and maintaining robust data-driven applications that support regulated business processes and executive decision-making.